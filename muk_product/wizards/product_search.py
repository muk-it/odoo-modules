...
class ProductSearch(models.TransientModel):
    ...
    _explanation = (
        'A bulk search over products: paste a list of internal references, names '
        'or barcodes, preview the matches and open them as a product list. Use it '
        'to find many products at once from a spreadsheet column or an order.'
    )

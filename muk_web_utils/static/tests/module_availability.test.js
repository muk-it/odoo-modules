...
test('the module name is derived from a module_ settings field only', async () => {
    expect(moduleNameFromField('module_muk_ai_skills')).toBe('muk_ai_skills');
    expect(moduleNameFromField('group_multi_company')).toBe('');
});

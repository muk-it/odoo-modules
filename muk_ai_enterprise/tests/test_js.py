...
class TestHoot(odoo.tests.HttpCase):
    """Run the muk_ai_enterprise HOOT JavaScript test suite."""
    ...
    def setUpClass(cls) -> None:
        ...
        cls.hoot_user = new_test_user(
            cls.env,
            login='hoot_muk_ai_enterprise',
            password='hoot_muk_ai_enterprise',
    ...
    @odoo.tests.no_retry
    def test_hoot_muk_ai_enterprise(self):
        self.browser_js(
            '/web/tests?headless&loglevel=2&preset=desktop'
            '&timeout=15000&tag=muk_ai_enterprise',
            '',
            '',

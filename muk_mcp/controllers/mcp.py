...
class MCPController(http.Controller):
    ...
    def _get_unauthenticated_methods(self, profile: ProtocolProfile) -> frozenset:
    ...
    def _get_shared_handlers(self) -> dict:
    ...
    def _get_handlers(self, profile: ProtocolProfile) -> dict:

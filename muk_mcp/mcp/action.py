...
# `odoo.service.model.get_public_method` was introduced in 18 and isn't
# available on 16/17. Inline an equivalent here so MCPMixin can refuse
# private/unsafe method calls.
_UNSAFE_ATTRIBUTES = (
    'mro',
    '__class__',
    '__init__',

...
class TestHoot(odoo.tests.HttpCase):
    """Run the muk_ai_automation HOOT JavaScript test suite."""
    ...
    def setUpClass(cls) -> None:
        ...
        cls.hoot_user = new_test_user(
            cls.env,
            login='hoot_muk_ai_automation',
            password='hoot_muk_ai_automation',

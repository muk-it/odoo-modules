...
conversation on the next tick. A per-turn wallclock budget bounds total
work. All three caps are tunable via the system parameters
``muk_ai.max_iterations``, ``muk_ai.slice_wallclock_seconds`` and

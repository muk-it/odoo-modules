...
class IrModel(models.Model):
    ...
    def _ai_source_icons(self):
        ...
        The signature is deliberately unannotated: this branch's ormcache
        builds its key lambda from the raw signature text, which a return
        annotation makes syntactically invalid.

...
function registerMocks() {
    onRpc('muk_ai.session', 'read', ({ args }) => [{ ...SESSION_RECORD, id: args[0][0] }]);
    ...
    mockService('action', { doAction: (a) => { events.actions.push(a); return Promise.resolve(); } });
...
test('onOpenAttachment opens the file viewer via toFileModel', async () => {
    ...
    window_.onOpenAttachment({ id: 5, filename: 'p.png', mimetype: 'image/png', size: 10 });

...
tour.register('muk_cookies_reject_all', { test: true, url: '/' }, [
    {
...
tour.register('muk_cookies_accept_all', { test: true, url: '/' }, [
    {
...
tour.register('muk_cookies_customise', { test: true, url: '/' }, [
    {
...
tour.register('muk_cookies_embed', { test: true, url: '/muk-cookies-embed' }, [
    {
    ...
    {
        content: 'One embed grants that service, and no purpose beyond the necessary',
        trigger: 'body',
        in_modal: false,
        run: () => {
            assertGranted(['essential']);
...
tour.register('muk_cookies_clearing', { test: true, url: '/' }, [
    {
    ...
    {
        content: 'Including the per-property names only a declared pattern could reach',
        trigger: 'body',
        in_modal: false,
        run: () => {
...
tour.register('muk_cookies_layers', { test: true, url: '/' }, [
    {
    ...
    },
    {
        ...
        run: () => {
            ...
            if (!held) {
                throw new Error('The page can still be scrolled behind the dialog.');
            }

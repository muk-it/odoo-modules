{
    ...
    'live_test_url': 'https://youtu.be/mK9Bq8rIP3E',
    'contributors': [
    ...
    'assets': {
        'web._assets_primary_variables': [
            'muk_web_appsbar/static/src/webclient/appsbar/variables.scss',
        ],
        'web._assets_backend_helpers': [
            'muk_web_appsbar/static/src/webclient/appsbar/mixins.scss',
        ],
        'web.assets_web_dark': [
            (
                'after',
                'muk_web_appsbar/static/src/webclient/appsbar/variables.scss',
                'muk_web_appsbar/static/src/webclient/appsbar/variables.dark.scss',
            ),
        ],
        'web.assets_backend': [
            (
                ...
                'muk_web_appsbar/static/src/webclient/layout/layout.js',
            ),
            (
                'after',
                'web/static/src/webclient/webclient.xml',
                'muk_web_appsbar/static/src/webclient/layout/layout.xml',
            ),
            (
                'after',
                'web/static/src/webclient/webclient.js',
            ...
            'muk_web_appsbar/static/src/webclient/layout/layout.scss',
